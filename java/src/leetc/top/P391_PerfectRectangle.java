...
public class P391_PerfectRectangle {
    private static void add(HashMap<Integer, HashMap<Integer, Integer>> map, int row, int col) {
    ...
    private static boolean checkPoints(HashMap<Integer, HashMap<Integer, Integer>> map, int l, int d, int r, int u) {
